...
This script individually partitions each of the 15 Level-1 macro-clusters into smaller, 
balanced sub-groups (3–7 species each) for localized CNN sub-model training. This enables 
the CNN system better distinguish between highly similar species within the same cluster.
