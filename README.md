...
### 2.2 Hierarchical Optimization & Metric Evaluation
* **Scipy (cluster.hierarchy):** Used for performing HAC, calculating linkages, and generating diagnostic plots.
* **Ward’s Linkage Method:** Minimizes intra-cluster variance during recursive taxonomic partitioning.
...
---
## 3. Analysis Pipeline & Execution Flow
Pollen_analysis/
...
├── training/      # Refined model weights (.pth) and logs
└── audit/         # Confusion matrices and advanced evaluation logs
...
3. Cut the dendrogram at an optimized distance threshold to generate 15 distinct parent clusters.
### 3.2 Balanced Sub-grouping (Level-2)
1. Split the 15 clustered prototypes into smaller subgroups to train specific CNN sub-models.
...
### 3.3 Recursive Hierarchical Training & Expert Models (Level-3)
...
* **Precision:** The proportion of correctly predicted positive observations out of all predictions made for that specific class. Measures the ability to avoid false positives.
